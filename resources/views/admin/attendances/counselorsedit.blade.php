...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            ...
            <form class='mt-5' action="{{ route('admin.counselors.update', $counselor->id) }}" method="post">
                @csrf
                @method('PATCH')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id='contact_phone' name='contact_phone'
                            value={{ old('contact_phone', $counselor->contact_phone) }}>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="contact_email" name='contact_email'
                            value={{ old('contact_email', $counselor->contact_email) }}>
                    </div>
                </div>
