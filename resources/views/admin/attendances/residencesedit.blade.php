...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            ...
            <form class='mt-5' action="{{ route('admin.residences.update', $residence->id) }}" method="post">
                @csrf
                @method('PATCH')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id='contact_name' name='contact_name'
                            value={{ old('contact_name', $residence->contact_name) }}>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id='contact_phone' name='contact_phone'
                            value={{ old('contact_phone', $residence->contact_phone) }}>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="contact_email" name='contact_email'
                            value={{ old('contact_email', $residence->contact_email) }}>
                    </div>
                </div>
